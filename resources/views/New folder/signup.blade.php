...
@section('content')
  <main class="form-signin">
    <form action="/signup" method="POST">
      ...
      <img class="mb-4" src="/assets/img/wedding.png" alt="Palm Tree" width="72" height="57">
      ...
      <p class="mt-3 mb-3 text-muted">&copy; SPK Pemilihan gedung Pernikahan {{ now()->year }}</p>
    </form>
  </main>
@endsection